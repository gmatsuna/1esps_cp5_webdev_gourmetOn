export default function Hero() {
  return (
    <>
      ...
      >
        {/* Overlay um pouco mais escura para garantir contraste em espaço menor */}
        <div className="absolute inset-0 bg-gradient-to-r from-black/90 via-black/60 to-transparent"></div>
        
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-xl"> {/* Limitador de largura ligeiramente menor */}
            
            {/* TÍTULO: Reduzido de text-6xl para text-4xl (e 3xl no mobile) */}
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-2 leading-tight">
              Comida de Chef,<br/>
              <span className="text-lime-400">na sua Mesa.</span>
            </h1>
            
            {/* PARÁGRAFO: Reduzido de text-xl para text-base e margem menor (mb-5) */}
            <p className="text-base text-gray-300 max-w-lg mb-5 leading-relaxed">
              Os melhores pratos dos restaurantes exclusivos da cidade com entrega ultra-rápida.
            </p>
            
            {/* BOTÃO: Reduzido padding (px-6 py-3) e tamanho da fonte (text-base) */}
