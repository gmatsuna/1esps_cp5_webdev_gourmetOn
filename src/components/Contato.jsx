          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 relative z-10">
            ...
            <div className="w-full lg:w-1/2 text-center lg:text-left">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Fique por dentro das <span className="text-lime-400">nossas novidades.</span>
              </h2>
              <p className="text-slate-300 text-lg mb-8">
                Assine nossa newsletter e receba cupons de desconto exclusivos, 
                além de ser o primeiro a saber sobre novos restaurantes na sua região.
              </p>
            ...
            <div className="w-full lg:w-1/2">
              ...
              {/* Texto de rodapé com cor mais clara (slate-400) para melhor leitura */}
