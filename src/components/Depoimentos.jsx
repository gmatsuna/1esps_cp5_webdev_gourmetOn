  ...
  const reviews = [
    {
      ...
      content: "O GourmetOn mudou minha rotina. A comida chega sempre impecável e os entregadores são extremamente educados. Não uso outro app!"
    },
    {
      name: "Carlos Eduardo",
      role: "Desenvolvedor de Software",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150",
      content: "A variedade de restaurantes é incrível. Consigo pedir desde o meu PF favorito até pratos gourmet mais sofisticados sem erro."
    },
    {
      name: "Mariana Costa",
      role: "Nutricionista",
      image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150",
      content: "Adoro os filtros de restrição alimentar. É o único aplicativo onde encontro opções saudáveis e detalhadas com tanta facilidade."
    }
  ];
  return (
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-600 max-w-xl mx-auto">
            Milhares de pessoas já transformaram suas refeições com a praticidade e qualidade do GourmetOn.
          </p>
        </div>
