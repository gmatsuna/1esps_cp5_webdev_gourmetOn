      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <h1
          className={`text-2xl font-bold transition-colors ${
            rolou ? "text-gray-900" : "text-white"
          }`}
        >
        ...
        <div className="space-x-8 text-gray-300">
          ...
          <a href="#apresentacao" className="hover:text-lime-400">
            App
          </a>
          ...
          <a href="#contato" className="hover:text-lime-400">
            Contato
          </a>
          <a href="#rodape" className="hover:text-lime-400">
            Rodapé
          </a>
        </div>
      </div>
